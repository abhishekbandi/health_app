...
class Login extends State<Login_screen> {
  ...
  SharedPreferences logindata, loginname;
  bool newuser;
  ...
  void check_if_already_login() async {
    ...
    loginname = await SharedPreferences.getInstance();
  ...
  void verify() {
    setState(() {
            ...
            content:  Container(
              child: Column(
                children: [
                  ...
                  Image.asset("assets/images/register.gif",width: 150,
                    height: 100,),
                ],
              ),
              width: 150,
      ...
      } else if (check_email == "a@gmail.com" && check_password == "12") {
        return showDialog(
          context: context,
          builder: (ctx) => AlertDialog(
            ...
            content: Container(
                child: Column(
                  children: [
                    Image.asset("assets/images/cong.gif",width: 150,
                      height: 100,),
            ...
            actions: <Widget>[
              FlatButton(
                onPressed: () {
                  ...
                  if (userid != '' && password_value != '') {
                    print('Successfull');
                    logindata.setBool('login', false);
                    logindata.setString('userid', userid);
                    loginname.setString('username', username);
        ...
        return showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content:  Container(
              child: Column(
                children: [
                  Image.asset("assets/images/re.gif",width: 150,
                    height: 100,),
